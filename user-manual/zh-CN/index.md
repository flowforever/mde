...
4. 按需要查看 [搜索](./search.md)、[链接](./links.md)、[AI](./ai.md)、[Automation Center](./automation.md) 和 [设置](./settings.md)。
...
如果你在维护测试、截图、设计评审或需求文档，可以查看 [内部组件命名参考](./component-names.md)。普通用户不需要先阅读这页。
