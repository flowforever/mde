...
const EN_MESSAGES = {
  ...
  "agentChat.assistantAvatar": "AI",
  "agentChat.assistantName": "Agent Chat",
  ...
  "agentChat.changedFilesUnavailable": "Changed-file summary unavailable for this turn.",
  "agentChat.close": "Close Agent Chat",
  "agentChat.composerPlaceholder": "Ask about this Markdown...",
  "agentChat.contextAndPermission": "Context & permission",
  "agentChat.contextPreview": "Context",
  "agentChat.contextSummary": "workspace · document · selection · max permission",
  "agentChat.document": "Document",
  "agentChat.diagnostic": "Agent Chat diagnostic",
  "agentChat.includeDocumentContext": "Include document context",
  "agentChat.includeSelectionContext": "Include selection context",
  "agentChat.maxPermission": "Max permission",
  "agentChat.messageField": "Message Agent Chat",
  "agentChat.newSession": "New session",
  "agentChat.noDocument": "No document",
  "agentChat.noMessages": "No messages yet",
  "agentChat.noSelection": "No selection",
  "agentChat.permission": "Permission",
  "agentChat.pinSelection": "Pin selection",
  "agentChat.removePinnedSelection": "Remove pinned selection {index}",
  "agentChat.removeAttachment": "Remove attachment {fileName}",
  "agentChat.resizePanel": "Resize Agent Chat panel",
  "agentChat.send": "Send",
  "agentChat.selection": "Selection",
  "agentChat.session": "Session",
  "agentChat.stop": "Stop",
  "agentChat.systemAvatar": "SYS",
  "agentChat.systemName": "System",
  "agentChat.thinking": "Thinking...",
  "agentChat.title": "Agent Chat",
  "agentChat.turnFailed": "Agent Chat turn failed. Check Codex and try again.",
  "agentChat.turnFailedWithReason": "Agent Chat turn failed: {reason}",
  "agentChat.untitledSession": "Untitled chat",
  "agentChat.userAvatar": "ME",
  "agentChat.userName": "You",
  "agentChat.workspace": "Workspace",
  "automation.archiveFlow": "Archive automation-flow",
  "automation.agentChat": "Automation Agent Chat",
  "automation.adapterDiscoveredSource": "Adapter source",
  ...
  "automation.automationFlowEnabledSection": "Automation-flow enabled",
  "automation.automationFlowNotEnabledSection": "Automation-flow not enabled",
  ...
  "automation.blockedStartDiagnostics": "Start diagnostics",
  ...
  "automation.diagnostics.automationDiscovery.runCapabilityUnavailable":
    "Automation discovery cannot run because the required adapter is unavailable.",
  "automation.diagnostics.automationRun.taskNotFound":
  ...
  "automation.diagnosticCode": "Code: {code}",
  "automation.diagnosticFile": "File: {path}",
  "automation.diagnosticFlow": "Flow: {flowId}",
  "automation.diagnosticManagementAction": "Open Automation Flows",
  "automation.diagnosticUnknownField": "the required field",
  "automation.diagnosticUnknownSection": "the required section",
  ...
  "automation.disableFlowNamed": "Disable automation-flow {name}",
  ...
  "automation.enableFlowNamed": "Enable automation-flow {name}",
  ...
  "automation.globalSection": "Global",
  "automation.globalAutomationFlows": "Global automation flows",
  "automation.globalAutomationFlowsSubtitle": "global automation-flows",
  ...
  "automation.noSelectedExecutor": "No executor",
  ...
  "automation.executorSelector": "Executor",
  "automation.manageAutomationFlows": "Manage automation flows",
  "automation.manageAutomationFlowsForScope": "Manage flows for {workspace}",
  ...
  "automation.primaryExecutor": "Primary executor",
  ...
  "automation.readyFlowline": "Ready Flowline",
  ...
  "automation.remoteMrSource": "Remote merge request",
  ...
  "automation.closeRunDetails": "Close run details",
  "automation.openRunDetailsForRun": "View run details for run {runId}",
  "automation.parseProcess": "Parse process",
  "automation.parseResult": "Parse result",
  "automation.parseResultEmpty": "No parsed task list items for this run.",
  "automation.runHistory": "Run history",
  "automation.runHistoryEmpty": "No automation run records yet.",
  "automation.runDetails": "Run details",
  "automation.runKindDiscovery": "Discovery",
  "automation.runKindTask": "Task",
  "automation.runProcessDiscoveredSourcesMany":
    "Parsed {count} task list items",
  "automation.runProcessDiscoveredSourcesOne": "Parsed 1 task list item",
  "automation.runProcessStarted": "Started",
  "automation.runProcessStateUpdated": "State updated: {state}",
  "automation.runStateAbandoned": "Abandoned",
  "automation.runStateCancelled": "Cancelled",
  "automation.runStateFailed": "Failed",
  "automation.runStateInterrupted": "Interrupted",
  "automation.runStateRecoverable": "Recoverable",
  "automation.runStateStarting": "Starting",
  "automation.runUpdatedAt": "Updated {time}",
  "automation.running": "Running",
  "automation.runningDescription": "Tasks currently executing.",
  "automation.openNativeSessionForRun": "Open native session for run {runId}",
  "automation.openNativeSession": "Open native session",
  "automation.openNativeSessionFailed": "Unable to open native session.",
  ...
  "automation.selectedAutomationSources": "Selected automation-flow sources",
  ...
  "automation.setupDiagnosticsSummaryMany":
    "{count} setup issues need changes before tasks can appear",
  "automation.setupDiagnosticsSummaryOne":
  ...
  "automation.updateFlowLifecycleFailed":
    "Unable to update automation-flow lifecycle.",
  ...
  "automation.stopFlowDeferred": "Stopping a whole flow is deferred in this slice.",
  "automation.startTask": "Start automation task",
  "automation.startTaskWithSelectedExecutor": "Start with selected executor",
  ...
  "automation.taskSourceHint": "Source: {source}",
  ...
  "automation.unknownSource": "Unknown source",
  "automationFlow.diagnostics.defaultEngineNotAllowed":
    "The default engine is not allowed. Add it to allowedEngines or choose an allowed engine.",
  "automationFlow.diagnostics.duplicateExecutorId":
    "Two executors use the same id. Rename one executor id so each executor is unique.",
  "automationFlow.diagnostics.duplicateExecutorPath":
    "Two executors point to the same Markdown file. Remove one duplicate executor path or give each executor its own file.",
  "automationFlow.diagnostics.invalidAppliedGlobalRefs":
    "The applied global flow list is invalid. Fix the JSON list of global automation-flow references.",
  "automationFlow.diagnostics.invalidField":
    "Field {field} is invalid. Update the value in the automation-flow frontmatter.",
  "automationFlow.diagnostics.invalidFrontmatter":
    "The frontmatter is invalid. Fix the YAML block at the top of the automation-flow file.",
  "automationFlow.diagnostics.missingExecutor":
    "No enabled executor is available. Add or enable a Markdown or skill executor for this automation-flow.",
  "automationFlow.diagnostics.missingFrontmatter":
    "Frontmatter is missing. Add a YAML frontmatter block to the automation-flow file.",
  "automationFlow.diagnostics.missingRequiredField":
    "Missing required field {field}. Add it to the automation-flow frontmatter.",
  "automationFlow.diagnostics.missingRequiredSection":
    "Missing required section {section}. Add this Markdown section to the automation-flow file.",
  "automationFlow.diagnostics.ownershipTie":
    "Multiple automation-flows match the same task with equal priority. Adjust match rules or priority so one flow owns the task.",
  "automationFlow.diagnostics.requiredExecutorDisabled":
    "A required executor is disabled. Enable that executor or remove it from the required executor list.",
  "automationFlow.diagnostics.requiredExecutorMissing":
    "A required executor is missing. Add the executor file or remove it from the required executor list.",
  "automationFlow.diagnostics.templateMissingRequiredInput":
    "A required template input is missing. Fill in {field} before creating the automation-flow.",
  "automationSource.diagnostics.invalidFrontmatter":
    "A task source has invalid frontmatter. Fix the YAML block at the top of the listed task document.",
  ...
  "explorer.deleteAutomationFlow": "Delete automation flow {name}",
  ...
  "explorer.addAutomationExecutor": "Add executor",
  "explorer.addAutomationExecutorForFlow": "Add executor to {name}",
  "explorer.addAutomationFlow": "Add automation flow",
  "explorer.applyGlobalAutomationFlow": "Apply global workflow",
  "explorer.automationFlowActions": "{name} automation flow actions",
  "explorer.automationFlows": "Automation Flows",
  "explorer.automationMarkdownExecutor": "Markdown executor",
  "explorer.automationMarkdownExecutorLabel": "Open Markdown executor {name}",
  "explorer.automationSkillExecutor": "Skill executor",
  "explorer.automationSkillExecutorLabel": "Open skill executor {name}",
  "explorer.files": "Files",
  "explorer.globalAutomationFlow": "Global",
  "explorer.header": "Explorer",
  "explorer.hideHiddenEntries": "Hide hidden entries",
  "explorer.jumpGlobalAutomationFlow": "Jump to global flow {name}",
  ...
  "explorer.noAutomationFlows": "No automation flows",
  "explorer.noRecentFiles": "No recent files",
  "explorer.openAutomationFlow": "Open automation flow {name}",
  ...
  "explorer.refreshAutomationSkills": "Refresh automation skills",
  "explorer.removeGlobalAutomationFlow": "Remove global flow {name} from workspace",
  "explorer.resizeRecentFilesPanel": "Resize recent files panel",
  "explorer.renameAutomationFlow": "Rename automation flow {name}",
  ...
  "explorer.workspaceAutomationFlow": "Workspace",
...
export const isAppTextKey = (key: string): key is AppTextKey =>
  key in EN_MESSAGES;
...
const ZH_MESSAGES: Record<AppTextKey, string> = {
  ...
  "agentChat.changedFilesUnavailable": "本轮无法生成变更文件摘要。",
  "agentChat.close": "关闭 Agent Chat",
  "agentChat.composerPlaceholder": "询问当前 Markdown...",
  "agentChat.contextAndPermission": "上下文和权限",
  "agentChat.contextPreview": "上下文",
  "agentChat.contextSummary": "工作区 · 文档 · 选区 · 最高权限",
  "agentChat.document": "文档",
  "agentChat.diagnostic": "Agent Chat 诊断",
  "agentChat.includeDocumentContext": "发送文档上下文",
  "agentChat.includeSelectionContext": "发送选区上下文",
  "agentChat.maxPermission": "最高权限",
  "agentChat.messageField": "输入 Agent Chat 消息",
  "agentChat.newSession": "新建会话",
  "agentChat.noDocument": "无文档",
  "agentChat.noMessages": "还没有消息",
  "agentChat.noSelection": "无选区",
  "agentChat.permission": "权限",
  "agentChat.pinSelection": "固定选区",
  "agentChat.removePinnedSelection": "移除固定选区 {index}",
  "agentChat.removeAttachment": "移除附件 {fileName}",
  "agentChat.resizePanel": "调整 Agent Chat 面板宽度",
  "agentChat.send": "发送",
  "agentChat.selection": "选区",
  "agentChat.session": "会话",
  "agentChat.stop": "停止",
  "agentChat.systemAvatar": "SYS",
  "agentChat.systemName": "系统",
  "agentChat.thinking": "思考中...",
  "agentChat.title": "Agent Chat",
  "agentChat.turnFailed": "Agent Chat 回合失败。请检查 Codex 后重试。",
  "agentChat.turnFailedWithReason": "Agent Chat 回合失败：{reason}",
  "agentChat.untitledSession": "未命名聊天",
  "agentChat.userAvatar": "我",
  "agentChat.userName": "你",
  "agentChat.workspace": "工作区",
  "automation.archiveFlow": "归档自动化流程",
  "automation.agentChat": "自动化 Agent Chat",
  "automation.adapterDiscoveredSource": "适配器来源",
  "automation.archivedFilter": "已归档",
  "automation.activeFlows": "活跃流程",
  "automation.addFlowForWorkspace": "为 {workspace} 添加流程",
  "automation.automationFlowEnabledSection": "已启用自动化流程",
  "automation.automationFlowNotEnabledSection": "未启用自动化流程",
  "automation.automationFlowsLabel": "个自动化流程",
  "automation.bucketEmpty": "此队列暂无任务。",
  "automation.bugReportsSource": "Bug 报告",
  "automation.centerTitle": "自动化中心",
  "automation.blockedStartDiagnostics": "启动诊断",
  "automation.chooseTemplateForWorkspace":
    "选择模板，为这个工作区启动自动化。",
  ...
  "automation.diagnosticCode": "代码：{code}",
  "automation.diagnosticFile": "文件：{path}",
  "automation.diagnosticFlow": "流程：{flowId}",
  "automation.diagnosticManagementAction": "打开自动化流程",
  "automation.diagnosticUnknownField": "必填字段",
  "automation.diagnosticUnknownSection": "必填章节",
  "automation.diagnosticWarning": "警告",
  "automation.decisionPrompt": "需要决策",
  "automation.disableFlow": "停用自动化流程",
  "automation.disableFlowNamed": "停用自动化流程 {name}",
  "automation.done": "已完成",
  "automation.doneDescription": "报告和验证历史。",
  "automation.editFlow": "编辑自动化流程",
  "automation.enableFlow": "启用自动化流程",
  "automation.enableFlowNamed": "启用自动化流程 {name}",
  "automation.editorAssetsUnavailable":
    "自动化流程编辑器不附加图片资产。",
  ...
  "automation.flowToolbar": "自动化流程工具栏",
  "automation.flowsCount": "个流程",
  "automation.flowline": "流程线",
  "automation.flowlineEmpty": "选择任务后查看它的流程线。",
  "automation.flowlineTaskLifecycleDescription":
    "阶段计划来自任务内容和自动化流程运行状态。",
  "automation.globalSection": "全局",
  "automation.globalAutomationFlows": "全局自动化流程",
  "automation.globalAutomationFlowsSubtitle": "全局自动化流程",
  ...
  "automation.newAutomationFlow": "新建自动化流程",
  "automation.noSelectedSource": "未选择自动化流程来源。",
  "automation.noSelectedExecutor": "无执行器",
  "automation.noActiveFlows": "暂无活跃流程",
  "automation.noWorkspace": "无工作区",
  "automation.openAgentChat": "打开自动化 Agent Chat",
  "automation.owningFlow": "所属流程",
  "automation.executorSelector": "执行器",
  "automation.manageAutomationFlows": "管理自动化流程",
  "automation.manageAutomationFlowsForScope": "管理 {workspace} 的流程",
  ...
  "automation.primaryExecutor": "主执行器",
  "automation.projectionError": "无法加载自动化任务。",
  "automation.ready": "就绪",
  "automation.readyDescription": "由自动化流程认领的候选任务。",
  "automation.readyFlowline": "就绪流程线",
  "automation.readyFlowlineDescription":
  ...
  "automation.remoteMrSource": "远程 merge request",
  "automation.resizeSidebar": "调整自动化中心侧边栏宽度",
  "automation.restoreFlow": "恢复自动化流程",
  "automation.returnToWorkspace": "回到工作区",
  "automation.closeRunDetails": "关闭运行详情",
  "automation.openRunDetailsForRun": "查看运行 {runId} 的详情",
  "automation.parseProcess": "解析过程",
  "automation.parseResult": "解析结果",
  "automation.parseResultEmpty": "本次运行没有解析出的任务列表项。",
  "automation.runHistory": "运行记录",
  "automation.runHistoryEmpty": "暂无自动化运行记录。",
  "automation.runDetails": "运行详情",
  "automation.runKindDiscovery": "发现",
  "automation.runKindTask": "任务",
  "automation.runProcessDiscoveredSourcesMany":
    "解析出 {count} 个任务列表项",
  "automation.runProcessDiscoveredSourcesOne": "解析出 1 个任务列表项",
  "automation.runProcessStarted": "已开始",
  "automation.runProcessStateUpdated": "状态更新：{state}",
  "automation.runStateAbandoned": "已放弃",
  "automation.runStateCancelled": "已取消",
  "automation.runStateFailed": "失败",
  "automation.runStateInterrupted": "已中断",
  "automation.runStateRecoverable": "可恢复",
  "automation.runStateStarting": "启动中",
  "automation.runUpdatedAt": "更新于 {time}",
  "automation.running": "运行中",
  "automation.runningDescription": "正在执行的任务。",
  "automation.openNativeSessionForRun": "打开运行 {runId} 的原生会话",
  "automation.openNativeSession": "打开原生会话",
  "automation.openNativeSessionFailed": "无法打开原生会话。",
  "automation.saveFlow": "保存自动化流程",
  "automation.saveFlowFailed": "无法保存自动化流程。",
  "automation.showArchivedFlows": "显示已归档流程",
  "automation.signalStack": "信号队列",
  "automation.selectedAutomationSources": "已选择的自动化流程来源",
  "automation.selectedSources": "已选择当前工作区的自动化流程来源",
  "automation.sourceSummary": "来源",
  "automation.setupDiagnostics": "设置诊断",
  "automation.setupDiagnosticsSummaryMany":
    "{count} 个设置问题需要修改，修复后才会出现在任务队列中",
  "automation.setupDiagnosticsSummaryOne":
    "1 个设置问题需要修改，修复后才会出现在任务队列中",
  "automation.submitDecisionFailed": "无法提交决策，请刷新后重试。",
  "automation.updateFlowLifecycleFailed": "无法更新自动化流程生命周期。",
  "automation.statusArchived": "流程已归档",
  "automation.statusDisabled": "流程已停用",
  "automation.statusEnabled": "流程已启用",
  "automation.statusSetup": "流程需要设置",
  "automation.stopFlow": "停止自动化流程",
  "automation.stopFlowDeferred": "此切片暂不支持停止整个流程。",
  "automation.startTask": "启动自动化任务",
  "automation.startTaskWithSelectedExecutor": "使用所选执行器启动",
  "automation.startTaskFailed": "无法启动自动化任务，请检查任务状态后重试。",
  "automation.taskStack": "任务栈",
  "automation.taskSourceHint": "来源：{source}",
  ...
  "automation.workspaceFilterPanel": "工作区 · 流程过滤器",
  "automation.workspaceFlows": "工作区流程",
  "automation.workspaceUnknown": "当前工作区",
  "automation.taskFirstQueue": "任务优先队列",
  "automation.taskFirstQueueDescription":
    "工作区只是过滤条件，每张任务卡都来自一个自动化流程。",
  "automation.taskDocsSource": "任务文档",
  "automation.unknownSource": "未知来源",
  "automationFlow.diagnostics.defaultEngineNotAllowed":
    "默认引擎不在允许列表中。请把它加入 allowedEngines，或改成允许的引擎。",
  "automationFlow.diagnostics.duplicateExecutorId":
    "有两个执行器使用了相同 ID。请重命名其中一个执行器 ID，确保每个执行器唯一。",
  "automationFlow.diagnostics.duplicateExecutorPath":
    "有两个执行器指向同一个 Markdown 文件。请删除重复路径，或为每个执行器使用独立文件。",
  "automationFlow.diagnostics.invalidAppliedGlobalRefs":
    "全局自动化流程引用列表无效。请修复全局 automation-flow 引用的 JSON 列表。",
  "automationFlow.diagnostics.invalidField":
    "字段 {field} 无效。请修改 automation-flow frontmatter 中的字段值。",
  "automationFlow.diagnostics.invalidFrontmatter":
    "Frontmatter 无效。请修复 automation-flow 文件顶部的 YAML 块。",
  "automationFlow.diagnostics.missingExecutor":
    "没有可用的启用执行器。请为这个 automation-flow 添加或启用 Markdown / skill 执行器。",
  "automationFlow.diagnostics.missingFrontmatter":
    "缺少 frontmatter。请在 automation-flow 文件顶部添加 YAML frontmatter。",
  "automationFlow.diagnostics.missingRequiredField":
    "缺少必填字段 {field}。请把它添加到 automation-flow frontmatter。",
  "automationFlow.diagnostics.missingRequiredSection":
    "缺少必填章节 {section}。请把这个 Markdown 章节添加到 automation-flow 文件。",
  "automationFlow.diagnostics.ownershipTie":
    "多个 automation-flow 以相同优先级匹配同一任务。请调整 match 规则或 priority，让一个流程拥有该任务。",
  "automationFlow.diagnostics.requiredExecutorDisabled":
    "必需执行器已停用。请启用该执行器，或从必需执行器列表中移除它。",
  "automationFlow.diagnostics.requiredExecutorMissing":
    "缺少必需执行器。请添加执行器文件，或从必需执行器列表中移除它。",
  "automationFlow.diagnostics.templateMissingRequiredInput":
    "缺少必需模板输入。创建 automation-flow 前请填写 {field}。",
  "automationSource.diagnostics.invalidFrontmatter":
    "任务来源的 frontmatter 无效。请修复列出的任务文档顶部 YAML 块。",
  "common.cancel": "取消",
  "common.close": "关闭",
  "common.delete": "删除",
  "common.done": "完成",
  ...
  "explorer.deleteAutomationFlow": "删除自动化流程 {name}",
  ...
  "explorer.addAutomationExecutor": "添加执行器",
  "explorer.addAutomationExecutorForFlow": "为 {name} 添加执行器",
  "explorer.addAutomationFlow": "添加自动化流程",
  "explorer.applyGlobalAutomationFlow": "应用全局工作流",
  "explorer.automationFlowActions": "{name} 自动化流程操作",
  "explorer.automationFlows": "自动化流程",
  "explorer.automationMarkdownExecutor": "Markdown 执行器",
  "explorer.automationMarkdownExecutorLabel": "打开 Markdown 执行器 {name}",
  "explorer.automationSkillExecutor": "Skill 执行器",
  "explorer.automationSkillExecutorLabel": "打开 Skill 执行器 {name}",
  "explorer.files": "文件",
  "explorer.globalAutomationFlow": "全局",
  "explorer.header": "资源管理器",
  "explorer.hideHiddenEntries": "隐藏被隐藏的条目",
  "explorer.jumpGlobalAutomationFlow": "跳转到全局流程 {name}",
  ...
  "explorer.noAutomationFlows": "暂无自动化流程",
  "explorer.noRecentFiles": "暂无最近文件",
  "explorer.openAutomationFlow": "打开自动化流程 {name}",
  ...
  "explorer.refreshAutomationSkills": "刷新自动化 Skills",
  "explorer.removeGlobalAutomationFlow": "从工作区移除全局流程 {name}",
  "explorer.resizeRecentFilesPanel": "调整最近文件面板高度",
  "explorer.renameAutomationFlow": "重命名自动化流程 {name}",
  ...
  "explorer.workspaceAutomationFlow": "工作区",
  "flowchart.label": "流程图",
