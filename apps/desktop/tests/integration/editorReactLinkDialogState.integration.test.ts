...
const linkDirectoriesUnitTestPath = join(
  process.cwd(),
  'apps/desktop/tests/unit/editorLinkDirectories.test.ts'
)
const linkDialogStateUnitTestPath = join(
  process.cwd(),
  'apps/desktop/tests/unit/editorLinkDialogState.test.ts'
)
const linkDirectoriesIntegrationTestPath = join(
  process.cwd(),
  'apps/desktop/tests/integration/editorLinkDirectories.integration.test.ts'
)
